# MajsoulMax mod.py — ported from https://github.com/Avenshy/MajsoulMax/blob/main/plugin/mod.py
# Key changes: class renamed to MajsoulMaxMod; imports adapted for Akagi's package structure;
# file paths use get_settings_dir() and resolve relative to this package.
import random
import requests
...
from akagi_ng.majsoulmax import liqi_new
from akagi_ng.majsoulmax.update_liqi import get_version

# Proto directory: akagi_ng/majsoulmax/proto/ (contains lqc.lqbin, liqi_pb2.py)
_PROTO_DIR = Path(__file__).resolve().parent / "proto"
# MajsoulMax mod settings file (in Akagi's config dir)
_SETTINGS_FILE = get_settings_dir() / "settings.mod.yaml"

# Module-level proto module placeholders (populated lazily in MajsoulMaxMod.__init__)
liqi_pb2 = None
config_pb2 = None
sheets_pb2 = None
basic_pb2 = None
...
class MajsoulMaxMod:
    ...
    def _lazy_import_proto(self):
        """Lazy-import proto modules (liqi_pb2.py is downloaded at runtime)."""
        global liqi_pb2, config_pb2, sheets_pb2, basic_pb2
        from akagi_ng.majsoulmax.proto import liqi_pb2 as _l
        from akagi_ng.majsoulmax.proto import config_pb2 as _c
        from akagi_ng.majsoulmax.proto import sheets_pb2 as _s
        from akagi_ng.majsoulmax.proto import basic_pb2 as _b
        liqi_pb2 = _l
        config_pb2 = _c
        sheets_pb2 = _s
        basic_pb2 = _b
...
''')
        ...
        with open(str(_PROTO_DIR / 'lqc.lqbin'), 'rb') as f:
            ...
            if msg_type == liqi_new.MsgType.Req:
                ...
                match method_name:
                    ...
                    case '.lq.Lobby.fetchAnnouncement':
                        ...
                        MyAnnouncement.title = 'Akagi + MajsoulMax mod载入成功'
